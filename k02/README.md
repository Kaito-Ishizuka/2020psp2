...
- ソースコードはOKですが、READMEのほうに
- ソースコードの説明と入出力結果を書いておいてください。

- OKです。あと、TAコメントが消えているので、プルリクエストのマージと、
- PC同期をやっておいてください。
- やり方は薗田先生の資料(MAIL?)に書かれていると思います。

[comment #20200707 kotaro]

- どこかのタイミングでコンフリクトしてマージできなかったようですね．マージできるようにしたので，もう一度マージしてください．
- 課題2は完了とします．（完了確認）
